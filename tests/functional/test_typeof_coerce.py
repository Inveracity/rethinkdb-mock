...
class TestTypeOf(MockTest):
    ...
    def test_null(self, conn):
        ...
        result = (
            r.db("a_db")
            .table("types")
            .map(lambda doc: doc["null_attr"].type_of())
            .run(conn)
        )
    ...
    def test_num(self, conn):
        ...
        result = (
            r.db("a_db")
            .table("types")
            .map(lambda doc: doc["num_attr"].type_of())
            .run(conn)
        )
        assertEqual(expected, list(result))
    ...
    def test_obj(self, conn):
        ...
        result = (
            r.db("a_db")
            .table("types")
            .map(lambda doc: doc["dict_attr"].type_of())
            .run(conn)
        )
        assertEqual(expected, list(result))
    ...
    def test_bool(self, conn):
        ...
        result = (
            r.db("a_db")
            .table("types")
            .map(lambda doc: doc["bool_attr"].type_of())
            .run(conn)
        )
        assertEqual(expected, list(result))
    ...
    def test_array(self, conn):
        ...
        result = (
            r.db("a_db")
            .table("types")
            .map(lambda doc: doc["list_attr"].type_of())
            .run(conn)
        )
        assertEqual(expected, list(result))
    ...
    def test_string(self, conn):
        ...
        result = (
            r.db("a_db")
            .table("types")
            .map(lambda doc: doc["str_attr"].type_of())
            .run(conn)
        )
        assertEqual(expected, list(result))
